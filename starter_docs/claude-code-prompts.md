...
Implement the standard alarm sets in the table in design 06. Make them
data-driven (a configuration document, not a switch statement) so adding a
resource type does not require a code change.
